...
enum BookNames {
    private static let shortNames: [Int: String] = [
        ...
        50: "Philippians", 51: "Colossians",
        52: "1 Thessalonians", 53: "2 Thessalonians",
        54: "1 Timothy", 55: "2 Timothy", 56: "Titus",
        57: "Philemon", 58: "Hebrews", 59: "James",
        60: "1 Peter", 61: "2 Peter", 62: "1 John",
        63: "2 John", 64: "3 John", 65: "Jude", 66: "Revelation"
    ]

    static func getShortName(_ bookId: Int) -> String {
        shortNames[bookId] ?? "Book \(bookId)"
    }

    static func isOldTestament(_ bookId: Int) -> Bool {
        (1...39).contains(bookId)
    }
}
